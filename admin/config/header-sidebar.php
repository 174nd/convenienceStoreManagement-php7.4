...
<aside class="main-sidebar sidebar-light-warning elevation-4 sidebar-no-expand">
  <!-- Brand Logo -->
  <a href="<?= $df['home']; ?>" class="brand-link bg-warning">
    <img src="<?= $df['brand-image']; ?>" alt="Logo" class="brand-image" style="opacity: 0.8;" />
    <span class="brand-text">Mini Market Puri Mart</span>
  </a>
