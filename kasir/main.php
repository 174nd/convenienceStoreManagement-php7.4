<?php
$backurl = '../';
require_once($backurl . 'kasir/config/settings.php');
$pset = array(
  'title' => 'Dashboard',
  'content' => 'Dashboard',
  'breadcrumb' => array(
...
<body class="hold-transition layout-top-nav text-sm">
  <div class="wrapper">
    <?php include $backurl . 'kasir/config/header.php'; ?>

    <!-- Content Wrapper. Contains page content -->
    <div class="content-wrapper">
      <?php include $backurl . 'kasir/config/content-header.php'; ?>
      ...
      <!-- /.modal -->
      <?php include $backurl . 'kasir/config/modal.php'; ?>
              ...
              success: function(data) {
                if (data['status'] == 'done') {
                  ...
                  $(data['data_penjualan']).each(function(index, hasil) {
                    table_penjualan.row.add([hasil['nm_barang'], hasil['qty_beli'], formatRupiah(hasil['hrg_barang'], 'Rp. ')]).draw();
                  });
                } else {
                  toastr.error('Terjadi Kesalahan!');
                }
